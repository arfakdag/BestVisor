var Dashboard = function () {
    ...
    return {
        ...
        initAmChart3: function () {
            ...
            $.post("/Campaign/GetData", { skip: Math.floor(Math.random() * 50) }, function (data) {
                console.log(data);
            }).done(function (data) {
                var chart = AmCharts.makeChart("dashboard_amchart_3", {
                    ...
                    "dataProvider": [{
                        ...
                        "expenses": data[1].expenses
                    }, {
                        "year": data[2].year,
                        "income": data[2].income,
                        "expenses": data[2].expenses
                    }, {
                        "year": data[3].year,
                        "income": data[3].income,
                        "expenses": data[3].expenses
                    }, {
                        "year": data[4].year,
                        "income": data[4].income,
                        "expenses": data[4].expenses
                    }, {
                        "year": data[5].year,
                        "income": data[5].income,
                        "expenses": data[5].expenses
                    }, {
                        "year": data[6].year,
                        "income": data[6].income,
                        "expenses": data[6].expenses
                    }, {
                        "year": data[7].year,
                        "income": data[7].income,
                        "expenses": data[7].expenses
                    }, {
                        "year": data[8].year,
                        "income": data[8].income,
                        "expenses": data[8].expenses
                    }, {
                        "year": data[9].year,
                        "income": data[9].income,
                        "expenses": data[9].expenses
                    }, {
                        "year": data[10].year,
                        "income": data[10].income,
                        "expenses": data[10].expenses
                    }, {
                        "year": data[11].year,
                        "income": data[11].income,
                        "expenses": data[11].expenses
                    }],
                    "valueAxes": [{
                        "axisAlpha": 0,
                        "position": "left"
        ...
        initAmChart4: function () {
            ...
            $.post("/Campaign/GetDataForPie", function (data) {
                console.log(data);
            }).done(function (data) {
                var chart = AmCharts.makeChart("dashboard_amchart_4", {
                    ...
                    "dataProvider": [
                    {
                        ...
                        "value": data[0].id
                            ...
                            "country": data[10].text,
                            "value": data[10].id
                    }, {
                            "country": data[11].text,
                            "value": data[11].id
                    }, {
                            "country": data[12].text,
                            "value": data[12].id
                    }, {
                            "country": data[13].text,
                            "value": data[13].id
                    }, {
                            "country": data[14].text,
                            "value": data[14].id
                    }, {
                            "country": data[15].text,
                            "value": data[15].id
                    }, {
                            "country": data[16].text,
                            "value": data[16].id
                    }],
                    "valueField": "value",
                    "titleField": "country",
